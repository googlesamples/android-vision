...
package com.irina.tensorflowexample.tracking;
...
import com.irina.tensorflowexample.env.Size;
...
public class ObjectTracker {
  ...
  static {
    try {
      System.loadLibrary("tensorflow_detector");
      libraryFound = true;
    } catch (UnsatisfiedLinkError e) {
      LOGGER.e("libtensorflow_detector.so not found, tracking unavailable");
    }
  }
