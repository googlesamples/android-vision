 ...
 */
package com.google.android.gms.vision.open;
...
public class CameraSource {
    ...
    private boolean mRequestedAutoFocus = false;
     ...
     * frames become available from the camera.<p>
     */
    ...
    public static class Builder {
        ...
        /**
         * Sets whether to enable camera auto focus.  If set to false (default), the camera's
         * default focus setting is used.  If set to true, a continuous video focus setting is used
         * (if supported by the camera hardware).  Default: false.
         */
        public Builder setAutoFocusEnabled(boolean autoFocusEnabled) {
            mCameraSource.mRequestedAutoFocus = autoFocusEnabled;
            return this;
        }
    ...
    /**
     * Closes the camera and stops sending frames to the underlying frame detector.<p>
     *
     * This camera source may be restarted again by calling {@link #start()} or
     * {@link #start(SurfaceHolder)}.<p>
     *
    ...
    /**
     * Selects the most suitable preview and picture size, given the desired width and height.<p>
     *
     ...
     * (i.e., without unnecessary context switching or waiting on the next frame).<p>
     *
    ...
    private class FrameProcessingRunnable implements Runnable {
         ...
         * switching or frame acquisition time latency.<p>
         *
                ...
                synchronized (mLock) {
                    ...
                    outputFrame = new Frame.Builder()
                        .setImageData(mPendingFrameData,
                                mPreviewSize.getWidth(), mPreviewSize.getHeight(), ImageFormat.NV21)
